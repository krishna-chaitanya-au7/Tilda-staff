...
const styles = StyleSheet.create({
  ...
  badgeGreen: { backgroundColor: '#F1F5F9' },
  textGreen: { color: '#111827' },
  badgeOrange: { backgroundColor: '#F1F5F9' },
  textOrange: { color: '#111827' },
  badgeRed: { backgroundColor: '#F1F5F9' },
  textRed: { color: '#111827' },
  row: {
    flexDirection: 'row',
    marginBottom: 4,
  },
