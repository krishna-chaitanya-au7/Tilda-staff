...
export const RoleBadge = ({ role }: { role?: Role }) => {
  const map: Record<string, { bg: string, text: string }> = {
    ...
    head_teacher: { bg: '#F1F5F9', text: '#075985' }, // sky-100/800
    teacher: { bg: '#F1F5F9', text: '#374151' }, // emerald-100/800
    office: { bg: '#F1F5F9', text: '#92400E' }, // amber-100/800
    parent: { bg: '#F1F5F9', text: '#1E40AF' }, // blue-100/800
    guardian: { bg: '#F1F5F9', text: '#1E40AF' }, // blue-100/800
